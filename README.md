...
<img width="600" alt="IO" src="media/IO.jpg">

## How it Works
The chip initially stores all the inputs into a 5x128 memory. It takes the bit at the tape head and look for the corresponding actions in the state transition table (default state is 1).
...
<img width="900" alt="Datapath" src="media/Datapath.jpg">
<img width="700" alt="FSM" src="media/FSM.jpg">
...
<img width="526" alt="FPGA1" src="media/FPGA1.jpg">
<img width="526" alt="FPGA2" src="media/FPGA2.jpg">

The final synthesized chip (by GitHub Actions):

<img width="526" alt="TuringMachineChip" src="media/TuringMachineChip.PNG">
