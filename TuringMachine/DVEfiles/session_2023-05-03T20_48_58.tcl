...
# DVE full session
# Saved on Wed May 3 20:48:58 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 22} {1500 852}}
...
catch { gui_list_select -id ${Data.1} {TuringMachine_test.dut.input_data TuringMachine_test.dut.clock TuringMachine_test.dut.reset TuringMachine_test.dut.Next TuringMachine_test.dut.Done TuringMachine_test.dut.display_out TuringMachine_test.dut.currState TuringMachine_test.dut.display_in TuringMachine_test.dut.tape_reg_out TuringMachine_test.dut.data_reg_out TuringMachine_test.dut.next_state_out TuringMachine_test.dut.tape_addr_out TuringMachine_test.dut.Compute_done TuringMachine_test.dut.Init TuringMachine_test.dut.NextState_en TuringMachine_test.dut.InputAddr_en TuringMachine_test.dut.StateAddr_ld TuringMachine_test.dut.StateAddr_en TuringMachine_test.dut.TapeAddr_en TuringMachine_test.dut.Write_en TuringMachine_test.dut.Read_en TuringMachine_test.dut.ReadInput TuringMachine_test.dut.PrevTape_en TuringMachine_test.dut.TapeReg_en TuringMachine_test.dut.DataReg_en TuringMachine_test.dut.Direction_en TuringMachine_test.dut.Display_en TuringMachine_test.dut.Display_rewrite TuringMachine_test.dut.Addr_sel TuringMachine_test.dut.Data_sel TuringMachine_test.dut.Data_eq TuringMachine_test.dut.Halt TuringMachine_test.dut.Left TuringMachine_test.dut.Memory_end TuringMachine_test.dut.next_state_prep TuringMachine_test.dut.next_state_in TuringMachine_test.dut.state_addr_in TuringMachine_test.dut.state_addr_out TuringMachine_test.dut.tape_addr_in TuringMachine_test.dut.tape_init_addr TuringMachine_test.dut.prev_tape_addr TuringMachine_test.dut.input_addr_out TuringMachine_test.dut.memory_addr TuringMachine_test.dut.write_data TuringMachine_test.dut.read_data TuringMachine_test.dut.direction_in TuringMachine_test.dut.direction_out TuringMachine_test.dut.tape_in TuringMachine_test.dut.tape_reg_in TuringMachine_test.dut.prev_tape_in TuringMachine_test.dut.prev_tape_out TuringMachine_test.dut.data_reg_in TuringMachine_test.dut.dw TuringMachine_test.dut.w TuringMachine_test.dut.aw }}
...
gui_open_source -id ${Source.1}  -replace -active TuringMachine_test /afs/andrew.cmu.edu/usr1/zhiyingm/private/18224/tiny-tapeout/TuringMachine/TuringMachine_test1.sv
