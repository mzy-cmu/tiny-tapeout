...
# DVE full session
# Saved on Fri May 5 21:15:24 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{-1 22} {1496 849}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 140} {height 378} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 437} {height 378} {dock_state left} {dock_on_new_line true} {child_data_colvariable 199} {child_data_colvalue 159} {child_data_coltype 102} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 336]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1452
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 336
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1497} {height 335} {dock_state bottom} {dock_on_new_line true}}
